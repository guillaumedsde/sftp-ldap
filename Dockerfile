...
LABEL org.label-schema.build-date=$BUILD_DATE \
  org.label-schema.name="sftp-ldap" \
  org.label-schema.description="Debian bullseyes based docker image for SFTP with ldap authentication" \
  org.label-schema.url="https://guillaumedsde.gitlab.io/sftp-ldap/" \
  org.label-schema.vcs-ref=$VCS_REF \
  org.label-schema.vcs-url="https://github.com/guillaumedsde/sftp-ldap" \
...
RUN apt-get update \
  ...
  && echo libpam-runtime libpam-runtime/profiles multiselect ldap | debconf-set-selections -v \
